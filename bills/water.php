...
// Query to get the water bills for the logged-in user
...
<table border="1">
    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            echo "<tr>";
            echo "<td>" . htmlspecialchars($row['water_bill_id']) . "</td>";
...
<script>
    function handleUserOptionsChange() {
        ...
        if (selectedValue === 'logout') {
            ...
            window.location.href = '/GAZA/pages/profile.php';
        }
    }
